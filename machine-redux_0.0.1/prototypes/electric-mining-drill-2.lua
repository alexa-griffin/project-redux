data:extend({
  ...
  {
    type = "technology",
    name = "advanced-material-extraction",
    icon_size = 128,
    ...
    prerequisites = { "avant-garde-science", "production-science" },
    unit =
    {
      count = 200,
      ingredients =
...

  {
    ...
    minable = {mining_time = 1, result = "electric-mining-drill-2"},
    max_health = 300,
    ...
    animations =
    {
      ...
      {
        priority = "high",
        filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/electric-mining-drill-N.png",
        line_length = 8,
        width = 98,
        height = 113,
        frame_count = 64,
        ...
        {
          priority = "high",
          filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/hr-electric-mining-drill-N.png",
          line_length = 8,
          width = 196,
          height = 226,
          frame_count = 64,
      ...
      {
        priority = "high",
        filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/electric-mining-drill-E.png",
        line_length = 8,
        width = 105,
        height = 98,
        frame_count = 64,
        ...
        {
          priority = "high",
          filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/hr-electric-mining-drill-E.png",
          line_length = 8,
          width = 211,
          height = 197,
          frame_count = 64,
      ...
      {
        priority = "high",
        filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/electric-mining-drill-S.png",
        line_length = 8,
        width = 98,
        height = 109,
        frame_count = 64,
        ...
        {
          priority = "high",
          filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/hr-electric-mining-drill-S.png",
          line_length = 8,
          width = 196,
          height = 219,
          frame_count = 64,
      ...
      {
        priority = "high",
        filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/electric-mining-drill-W.png",
        line_length = 8,
        width = 105,
        height = 98,
        frame_count = 64,
        ...
        {
          priority = "high",
          filename = "__machine-redux__/graphics/entity/electric-mining-drill-2/hr-electric-mining-drill-W.png",
          line_length = 8,
          width = 211,
          height = 197,
          frame_count = 64,
